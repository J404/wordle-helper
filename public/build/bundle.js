...
var app = (function () {
    ...
    */
    ...
    const solveWordle = (currGuess, orangeLetters, notLetters) => {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ['currGuess', 'orangeLetters', 'notLetters'];
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*currGuess*/ ctx[0] === undefined && !('currGuess' in props)) {
    			console.warn("<App> was created without expected prop 'currGuess'");
    		}

    		if (/*orangeLetters*/ ctx[1] === undefined && !('orangeLetters' in props)) {
    			console.warn("<App> was created without expected prop 'orangeLetters'");
    		}

    		if (/*notLetters*/ ctx[2] === undefined && !('notLetters' in props)) {
    			console.warn("<App> was created without expected prop 'notLetters'");
    		}
    	}
